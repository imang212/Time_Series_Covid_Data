...
trend_plot <- trend_data %>%
  ...
  scale_color_manual(values = c("original" = "gray50", "ma_4" = "green", "ma_52" = "red", "exp_smooth" = "purple"),
                     name = "Metoda",
...
ACF (Autokorelační funkce): Indikuje MA složku

PACF (Parciální ACF): Indikuje AR složku
...
selected_sarima <- tryCatch({
  ...
  # Jednodušší fallback
  arima(ts_daily_data, order = c(0, 1, 0))
})
